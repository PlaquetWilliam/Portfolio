        ...
        <section className="flex justify-center items-center w-full py-20">
            <div className='flex flex-col justify-center items-center w-1/2'>
                ...
                <p className="mt-4 text-xl font-medium text-center">
                    Pendant mon temps libre, j'aime créer divers sites pour des besoins professionnels ainsi que personnels. Voici ci-dessous quelques exemples 
                    de projets personnels que j'ai réalisés durant mon apprentissage dans le domaine du développement web. (Ayant des problèmes concernant l'hébergement, 
                    ces projets fonctionnent seulement en local donc voici simplement des screnshots).
                </p>
